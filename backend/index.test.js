...
test('checkDuplicates - check for empty existing array', () => {
    array1 = [];
    array2 = [1, 2, 3];
...
test('checkDuplicates - concatinating', () => {
...
test('checkDuplicates - removes duplicates', () => {
    array1 = [{link: 1}, {link: 2}];
...
test('checkTime - sorts after time', () => {
    array = [
